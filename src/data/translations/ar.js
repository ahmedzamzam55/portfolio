...
export const ar = {
  ...
  projectList: [
    ...
    {
      name: 'شركة PFSC',
      desc: 'الموقع الرسمي لشركة الخدمات الاحترافية الممتازة في المملكة العربية السعودية لتقديم الحلول والاستشارات والخدمات المتقدمة.',
      caseStudy: {
        problem: 'الحاجة إلى منصة رقمية حديثة وعالية الأداء لعرض الخدمات الاستشارية والاحترافية المتخصصة.',
        solution: 'تطوير واجهة ويب متجاوبة ومحسنة لمحركات البحث بتصميم عصري وتصفح سلس.',
        result: 'بناء حضور رقمي قوي وموثوق، وتحسين ظهور الخدمات وزيادة طلبات التواصل والتفاعل مع العملاء.'
      },
      tags: ['React.js', 'Vite', 'CSS3'],
    ...
    {
      name: 'عبدالرحمن العودة للمحاماة',
      desc: 'موقع إلكتروني متكامل لمكتب محاماة واستشارات قانونية في السعودية بتصميم عصري وهوية قانونية راقية ودعم الترافع والتوثيق.',
      caseStudy: {
        problem: 'حاجة مكاتب المحاماة إلى هوية رقمية موثوقة تعكس السرية والاحترافية وتتيح طلب الاستشارات بسهولة.',
        solution: 'تطوير موقع ويب قانوني متكامل وسريع بتصميم حديث وهوية متناسقة وتجربة مستخدم متميزة.',
        result: 'تعزيز الحضور الرقمي للمكتب، وتسهيل وصول العملاء للخدمات القانونية المتنوعة وزيادة طلبات الاستشارات.'
      },
      tags: ['React.js', 'Vite', 'CSS3'],
